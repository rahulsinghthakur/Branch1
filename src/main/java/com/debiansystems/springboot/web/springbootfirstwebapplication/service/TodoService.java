...
public class TodoService {
    ...
    static {
        todos.add(new Todo(1, "geetha", "Learn Spring MVC", new Date(),
                false));
        todos.add(new Todo(2, "geetha", "Learn Struts", new Date(), false));
        todos.add(new Todo(3, "geetha", "Learn Hibernate", new Date(),
                false));
    }
